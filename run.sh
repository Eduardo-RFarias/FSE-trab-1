...
sshpass -e ssh eduardofarias@164.41.98.16 -p 13508 "cd ~/fse; nohup ./fse_trab_1_server > server.log 2>&1 &"
sshpass -e ssh eduardofarias@164.41.98.16 -p 13508 "cd ~/fse; nohup ./fse_trab_1_ground_floor > ground_floor.log 2>&1 &"
sshpass -e ssh eduardofarias@164.41.98.16 -p 13508 "cd ~/fse; nohup ./fse_trab_1_first_floor > first_floor.log 2>&1 &"
sshpass -e ssh eduardofarias@164.41.98.16 -p 13508 "cd ~/fse; nohup ./fse_trab_1_second_floor > second_floor.log 2>&1 &"
